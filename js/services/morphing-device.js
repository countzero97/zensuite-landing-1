    ...
    devices: [
      {
        cName: 'md-device-1',
        canRotate: false,
        imgsrc: '/img/devices-img/site1.jpg'
        },
      {
        cName: 'md-device-2',
        canRotate: false,
        imgsrc: '/img/devices-img/site2.jpg'
        },
      {
        cName: 'md-device-3',
        canRotate: true,
        imgsrc: '/img/devices-img/site3.jpg',
        rotatedsrc: '/img/devices-img/site3r.jpg'
        },
      {
        cName: 'md-device-4',
        canRotate: true,
        imgsrc: '/img/devices-img/site4.jpg',
        rotatedsrc: '/img/devices-img/site4r.jpg'
        }
       ]
  },
